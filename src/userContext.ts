 ...
 */
export function encodeUserKey(key: string): string {
  if (!currentUserId) {
    return key;
  }
 ...
 */
export function decodeUserKey(encodedKey: string): { userId: string; key: string } | null {
 ...
 */
export function isCurrentUserKey(encodedKey: string): boolean {
 ...
 */
export function getCurrentUserKeyPrefix(): string | null {
  if (!currentUserId) {
    return null;
  }
